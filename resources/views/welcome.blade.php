                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title">Fruits & Légumes</h4>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title">Condiments, féculents, ...</h4>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon"><i class="bi bi-fire"></i> <i class="bi bi-snow2 ms-4"></i></div>
                            <h4 class="title">Plats chauds & froids</h4>
