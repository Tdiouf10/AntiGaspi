...
<div class="container">
    <div class="card-img-overlay">
        <div class="container w-100" style="margin-top: 100px;">
            ...
            <h2 class="my-5"><strong>LE TROC ALIMENTAIRE, C’EST SUPER !</strong></h2>
            ...
            <div class="row h5">
                ...
                <p class="mt-2 text-justify">Pour les grosses commandes normales, l'offre peut temporairement dépasser la demande. Cependant, si
            ...
            <h3 class="y-5 text-success"><strong>L’échange de nourriture lorsque le frigo déborde</strong></h3>
            <div class="row h5">
                <div class="col-lg-8 m-auto text-justify">
            ...
            <h3 class="my-5 text-success"><strong>Partager ses plats cuisinés</strong></h3>
            <div class="row h5">
                <div class="col-lg-8 m-auto text-justify">
            ...
            <div class="row h5 pb-5">
                ...
                <div class="col-lg-8 m-auto text-justify">
                    ...
                    <p>Alors qu'attendez-vous pour t'entez l'expérience et rejoindre la communauté d'AntiGaspi !</p>
                </div>
            </div>
        </div>
    </div>
