...
<div class="m-5">
    ...
    <div class="row h5">
        ...
        <p class="mt-2">Pour les grosses commandes normales, l'offre peut temporairement dépasser la demande. Cependant, si
    ...
    <div class="row h5">
        ...
        <p class="mt-2">N'hésitez plus, remplacez vos courses ! S'il y a trop de carottes, un membre de la famille qui habite à
