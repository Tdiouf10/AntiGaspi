...
@section('content')
    <div class="card">
        <div class="card-img-top">
            <img src="{{ URL('storage/img/fond_apropos.jpeg') }}" class="image-fond" alt=""/>
        </div>
        <div class="card-img-overlay">
            <div class="row m-5">
                ...
                <div class="row h2 justify-content-center mt-5">
                    Alors qu'attendez-vous pour t'entez l'expérience et rejoindre la communauté de nom-du-site !
                </div>
            </div>
        </div>
    </div>
